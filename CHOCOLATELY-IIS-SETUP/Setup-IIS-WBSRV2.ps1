...
# Chocolatey OR Web Platform Installer to 
...
New-WebAppPool -name "DTEKAZWEB2appPool"  -force

$appPool = Get-Item IIS:\AppPools\DTEKAZWEB2appPool | Select-Object *

$appPool.processModel.identityType = "NetworkService"
$appPool.enable32BitAppOnWin64 = 1
$appPool | Set-Item

md "c:\Web Sites\DTEKAZWEB2"


$site = $site = new-WebSite -name "DTEKAZWEBAPP2" -PhysicalPath "c:\Web Sites\DTEKAZWEB2" -HostHeader "dtekazweb2.ddns.net"-ApplicationPool "DTEKAZWEB2appPool" -force