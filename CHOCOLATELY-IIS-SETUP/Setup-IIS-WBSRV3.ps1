...
New-WebAppPool -name "DTEKAZWEB3appPool"  -force

$appPool = Get-Item IIS:\AppPools\DTEKAZWEB3appPool | Select-Object *

$appPool.processModel.identityType = "NetworkService"
$appPool.enable32BitAppOnWin64 = 1
$appPool | Set-Item

md "c:\Web Sites\DTEKAZWEB3"


$site = $site = new-WebSite -name "DTEKAZWEBAPP3" -PhysicalPath "c:\Web Sites\DTEKAZWEB3" -HostHeader "dtekazweb3.ddns.net"-ApplicationPool "DTEKAZWEB3appPool" -force